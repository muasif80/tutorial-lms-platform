...
public class Question {
    ...
    /**
     * Option labels (for choice questions); empty for SHORT_TEXT. Fetched eagerly: the grader
     * always needs them and a question is never loaded in bulk without them, so lazy loading
     * would only invite {@code LazyInitializationException} for zero benefit.
     */
